...
enum TraceViewer: StoreNamespace {
    ...
    struct StoreState {
        ...
        private struct CommitGraphLayout {
        ...
        private struct OverviewGraphPresentation {
        ...
        var selectedPreviousStateItem: TimelineItem? {
        ...
        private static func buildCommitGraphLayout(
            graph: SessionGraph,
            orderedIDs: [String],
            ...
            var edgeLineKindByPredecessorID: [String: [String: EdgeLineKind]] = [:]

            func edgeLineKind(to nodeID: String) -> EdgeLineKind {
            ...
            for id in orderedIDs {
                ...
                let lineKindByPredecessor: [String: EdgeLineKind] = Dictionary(
        ...
        private static func buildOverviewGraphPresentation(
        ...
        private static func shouldShowAppliedNode(
